...
def run_training_by_args(args):
    ...
    with strategy.scope():
        ...
        # return None, None, None
        print(f"\n{'-'*50}\nShuffling has been disabled. Batching has been disabled\n{'-'*50}")
        latest_save, hist = train_func.train(
            model, epochs, train_dataset, total_images, test_dataset, args.initial_epoch, lr_scheduler, args.basic_save_name, logs=args.tensorboard_logs,
        )
